...
def get_params():
    params = {
        'weight': '/data2/ljc/yolov8_jmse/YOLOv8.2/runs/train/aaa_jmse_heat3/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'EigenCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM
        'layer': [21],
        'backward_type': 'detect', # detect:<class, box, all> segment:<class, box, segment, all> pose:<box, keypoint, all> obb:<box, angle, all> classify:<all>
...
if __name__ == '__main__':
    ...
    model(r'/data2/ljc/RSSVG/images/train/1193.jpg', 'result')
